...
from includes import vmanages, user, password, from_user, from_password, mail_server, mail_port, recipient, alert_title
...
for vmanage in vmanages:
    ...
    baseurl = f'https://{vmanage}/dataservice'
    ...
    #
    filename = f'statsdb.{vmanage}.csv'
...
if hour == 0:
    ...
    for vmanage in vmanages:
        filename += [f'statsdb.{vmanage}.csv']
    message = create_email(from_user, recipient, alert_title, 'Home Depot daily StatsDB file', filename)
